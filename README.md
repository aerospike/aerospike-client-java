...
The Aerospike Java client — Maven artifact `com.aerospike:aerospike-client-jdk8`.
Authoritative version: `<revision>` in the root `pom.xml`.
Requires Java 8+ and Maven 3.0+.
The `stage` branch builds the Java 21 artifact.
...
├── examples/              ~33 runnable single-purpose programs
...
Generated Javadoc is published at https://javadoc.io/doc/com.aerospike/aerospike-client-jdk8/latest/index.html
